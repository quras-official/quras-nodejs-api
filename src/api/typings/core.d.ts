...
/** Perform a ClaimTransaction for all available QURAS Gas based on API */
export function claimQRG(config: apiConfig): Promise<apiConfig>
...
/** Helper method to get the maximum amount of gas claimable after spending all QURAS Coin. */
