 ...
 * @param {string} coin - Coin name. Ex XQC or XQG.
 * @param {string} currency - Three letter currency symbol.
 * @return {Promise<number>} price
 */
export const getPrice = (coin = 'XQC', currency = 'usd') => {
  log.warn(`This is deprecated in favor of getPrices. There is a known bug for QEPT1 tokens with this function.`)
 ...
 * @param {string[]} [coins] - Coin names. Ex XQC or XQG.
 * @param {string} [currency] - Three letter currency symbol.
 * @return {Promise<object>} object mapping symbol to price
 */
export const getPrices = (coins = ['XQC'], currency = 'usd') => {
