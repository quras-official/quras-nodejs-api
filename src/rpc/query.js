...
class Query {
   ...
   * @return {Query}
   */
  static getMemPoolCoin (scriptHash) {
    return new Query({
      method: 'getmempoolcoin',
      params: [scriptHash]
    })
  }
   ...
   * @return {Query}
   */
  static getMemPoolTransaction (scriptHash) {
    return new Query({
      method: 'getmempooltransaction',
      params: [scriptHash]
    })
  }
   ...
   * @return {Query}
   */
  static invoke (scriptHash, param) {
    return new Query({
      method: 'invoke',
      params: [scriptHash, param]
    })
  }
   ...
   * @return {Query}
   */
  static invokeFunction (scriptHash, operation, param) {
    return new Query({
      method: 'invokefunction',
      params: [scriptHash, operation, param]
    })
  }
...
export const queryRPC = (url, req, config = {}) => {
  ...
  return jsonRequest.post(url, jsonRpcData, { httpsAgent: agent }).then((response) => {
