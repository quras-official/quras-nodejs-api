...
export class RPCClient {
  ...
  /** Gets a list of all mempool coins waiting to be processed. */
  getMemPoolCoin(scriptHash: string): Promise<Array<any>>

  /** Gets a list of all mempool transaction waiting to be processed. */
  getMemPoolTransaction(scriptHash: string): Promise<Array<any>>
  ...
  /** Get claim amount */
  getClaimAmount(params: Array<any>): Promise<object>
}
