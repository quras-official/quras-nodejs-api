...
/**
 * @class Balance
 * @classdesc object describing the coins found within an Account. Look up various balances through its symbol. For example, XQC or XQG.
...
class Balance {
  constructor (bal = {}) {
    ...
    /** The mempool pending coins */
    this.mempool = bal.mempool
  }
   ...
   * @param {string} url - QURAS Node to check against.
