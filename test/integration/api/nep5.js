...
import { DEFAULT_RPC, CONTRACTS, QURAS_NETWORK } from '../../../src/consts'
...
describe('Integration: API NEP5', function () {
  ...
  it.skip('doTransferToken', () => {
    ...
    const gasCost = 0
    return NEP5.doTransferToken(QURAS_NETWORK.TEST, scriptHash, testKeys.c.wif, testKeys.b.address, transferAmount, gasCost)
      .then(({ result, txid }) => {
