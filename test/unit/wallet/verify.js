...
describe('Key Verification', function () {
  ...
  it('returns true for valid QTP1', () => {
    valid.qtp1s.map((qtp1) => V.isQTP1(qtp1).should.be.true)
  })

  it('returns true for valid QEP1', () => {
    valid.qep1s.map((qep) => V.isQEP1(qep).should.be.true)
  })
  ...
  it('returns false for invalid QTP1', () => {
    invalid.qtp1s.map((wif) => V.isQTP1(wif).should.be.false)
  })

  it('returns false for invalid QEP1', () => {
    invalid.qep1s.map((qep1) => V.isQEP1(qep1).should.be.false)
  })
